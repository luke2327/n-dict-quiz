import { headerHeight, textFieldColor } from '@themes/constant';
...
export const PureLightTheme = createTheme({
  colors: {
    ...
    highlight: {
      lighter: alpha(themeColors.highlight, 0.1),
  ...
  header: {
    height: headerHeight.mobileHeaderHeight,
  ...
  // grid components 이상으로 xs sm md lg xl 만 사용
  // breakpoints,
  components: {
    MuiBackdrop: {
      styleOverrides: {
      ...
      styleOverrides: {
        root: {
          '.Mui-focused:after': {
            ...
            borderBottomColor: textFieldColor.primary,
          },
        },
      },
    },
  ...
  typography: {
    fontFamily: '-apple-system, Hiragino, sans-serif',
    fontSize: 14,
    htmlFontSize: 15,
    h1: {
      fontWeight: 700,
